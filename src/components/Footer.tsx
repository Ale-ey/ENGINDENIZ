      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <ul className="flex flex-col space-y-3">
              <li><Link href="#" className="text-[#5a6a7e] hover:text-[#d71921] transition-colors font-serif">Imprint</Link></li>
              <li><Link href="#" className="text-[#5a6a7e] hover:text-[#d71921] transition-colors font-serif">Privacy Policy</Link></li>
              <li><Link href="#" className="text-[#5a6a7e] hover:text-[#d71921] transition-colors font-serif">Terms & Conditions</Link></li>
              <li><Link href="#" className="text-[#5a6a7e] hover:text-[#d71921] transition-colors font-serif">Cookie Policy</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <ul className="flex flex-col space-y-4">
              <li className="flex items-start">
                <MapPin className="w-5 h-5 text-[#d71921] mr-3 mt-0.5 shrink-0" />
              ...
              <li className="flex items-center">
                <Phone className="w-5 h-5 text-[#d71921] mr-3 shrink-0" />
                <span className="text-[#5a6a7e] font-serif">+43 1 514 30 9</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 text-[#d71921] mr-3 shrink-0" />
        ...
        <div className="pt-8 border-t border-[#e5e7eb] flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="#" className="w-8 h-8 rounded-full bg-[#e5e7eb] flex items-center justify-center text-[#5a6a7e] hover:bg-[#d71921] hover:text-white transition-colors">
